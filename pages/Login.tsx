      ...
      <div className="w-full max-w-sm space-y-6 relative z-10">
        <div className="metallic-glass p-8 rounded-[2.5rem] border border-white/5 space-y-6">
          <div className="space-y-4">
            <h3 className="text-slate-500 text-[10px] uppercase font-black tracking-widest text-center">{t.socialLogin}</h3>
            
            <button 
              onClick={onLogin}
              className="w-full flex items-center justify-center gap-3 bg-white text-slate-950 py-4 rounded-2xl font-bold text-sm hover:bg-slate-200 transition-all active:scale-95 shadow-xl"
            >
            ...
            <button 
              onClick={onLogin}
              className="w-full flex items-center justify-center gap-3 bg-[#1877F2] text-white py-4 rounded-2xl font-bold text-sm hover:opacity-90 transition-all active:scale-95 shadow-xl"
            >
          ...
          <div className="space-y-4">
            ...
            <button 
              onClick={onLogin}
              className="w-full bg-slate-800 text-slate-200 py-4 rounded-2xl font-bold text-sm border border-slate-700 hover:border-amber-500/50 transition-all active:scale-95"
            >
              {t.emailLogin}
            </button>
          </div>
